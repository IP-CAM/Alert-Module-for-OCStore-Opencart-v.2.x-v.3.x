...
class ControllerExtensionModuleAlert extends Controller
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->link('extension/module/alert', 'user_token=' . $this->session->data['user_token'], true);
    ...
    private function GetBreadCrumbs()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/alert', 'user_token=' . $this->session->data['user_token'], true)
        );
